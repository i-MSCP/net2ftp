...
<!-- Template /skins/mambo/login_module.template.php begin -->
...
<?php	printLanguageSelect("language", "", "margin: 0 0 0 0; border: 1px solid #cccccc;", ""); ?>
...
<div align="center" style="padding-top: 10px;"><input type="submit" name="submit" class="button" value="<?php echo __("Login"); ?>" title="<?php echo __("Login"); ?> (accesskey l)" accesskey="l" /></div>

</form>
<!-- Template /skins/mambo/login_module.template.php end -->
