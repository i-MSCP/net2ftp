...
<div style="border: 1px solid black; background-color: #DDDDDD; width: 400px; margin-<?php echo __("left"); ?>: auto; margin-<?php echo __("right"); ?>: auto; margin-top:50px; padding: 10px;">
