...
<?php 		} 
	/* ----- CKEditor or TinyMCE ----- */
			elseif ($textareaType == "ckeditor" || $textareaType == "tinymce") { ?>
				...
				<div id="body_shown" style="display: block;"><textarea cols="80" rows="20" id="text_splitted[middle]" name="text_splitted[middle]"><?php echo $text_splitted["middle"]; ?></textarea></div>
